...
- **HRRR/RAP smoke and GOES aerosol optical depth:** moderate-aerosol color enhancement with strong quality flags. Aerosol data is absent under clouds, so it must not be treated as a complete field.
...
- Refresh HRRR hourly, GOES features every 10–15 minutes near sunset, and emails every 15 minutes.
